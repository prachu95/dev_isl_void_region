...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ver_6) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Proposal :
...
;; "draw_object_right", the number would define the
;; object(selected using Structural Decomposition)
;; and the boolean is to decide the if the call is from
;; left or right abstract classs.
;; true -> left_img
;; false -> right_img 
