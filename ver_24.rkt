...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ver_24) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Proposal :
...
(define (status_check world)
  (cond 
    [ (equal? #true (intersection_checker world)) (draw_level (make-world (+ 1 (world-level world))
