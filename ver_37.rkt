...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ver_37) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Proposal :
...
(define (shape_drawer type colour)
  (cond
    ...
    [(= type 6) (regular-polygon object_width 8 "solid" colour)]
    [(= type 7) (regular-polygon object_width 11 "solid" colour)]
    [(= type 8) (regular-polygon object_width 14 "solid" colour)]
    [(= type 9) (regular-polygon object_width 17 "solid" colour)]
