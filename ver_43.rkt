...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ver_43) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Proposal :
...
(define (intersection_checker world)
  (and (<= (- (posn-x (Shape-pos (world-right_img world)))
       ...
       (and (>= (posn-x (Shape-pos (world-left_img world)))
                (- initial_void_region_x (/ (void_region_calc world) 2)))
...
; Example : Calls intersection_checker and updates
;           the level if true. 
...
(check-expect (draw_level (make-world 1
              ...
              (place-image (text (number->string 1) 50 "black")
                           ...
                           (place-image (rectangle (+ (* (* 1 void_region_ramp_up) void_region_width) void_region_width) world-height "solid" "LightSlateGray")
                                        initial_void_region_x initial_void_region_y
...
; Example : Drawing the centre void region. 
