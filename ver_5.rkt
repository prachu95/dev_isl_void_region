...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ver_5) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Proposal :
...
; Big bang definition
(big-bang (make-world start_level left_obj_starting_posn right_obj_starting_posn initial_current_game_status initial_final_game_status)
          [on-tick tick 1/300]
          [on-key key]
