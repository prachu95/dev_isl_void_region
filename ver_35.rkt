...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ver_35) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Proposal :
