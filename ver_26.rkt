...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ver_26) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Proposal :
...
(define (world-stop world)
    (equal? #true (world-final_game_status world)))
...
(define (status_check world)
  (cond 
    [ (equal? #true (intersection_checker world)) (make-world (+ 1 (world-level world))
