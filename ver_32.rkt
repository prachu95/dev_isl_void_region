...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ver_32) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Proposal :
...
;; Test Cases
(check-expect (future_void_region_calc (make-world 1
                                                   (make-Shape 1 (make-posn 0 300) "red")
                                                   (make-Shape 2 (make-posn 1200 300) "yellow")
                                                   #true))
              165)

(check-expect (future_void_region_calc (make-world 10
                                                   (make-Shape 1 (make-posn 0 300) "red")
                                                   (make-Shape 2 (make-posn 1200 300) "yellow")
                                                   #true))
              300)

(check-expect (future_void_region_calc (make-world 100
                                                   (make-Shape 1 (make-posn 0 300) "red")
                                                   (make-Shape 2 (make-posn 1200 300) "yellow")
                                                   #true))
              1650)
