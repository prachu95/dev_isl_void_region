...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ver_27) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Proposal :
...
(define (tick world)
  (cond
    [(equal? #true (world-current_game_status world))
     (cond
