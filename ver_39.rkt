...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ver_39) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Proposal :
...
(check-expect (tick (make-world 1
                                ...
                                #true))
              (make-world 1
                          (make-Shape 1 (make-posn -60 300) "red")
                          (make-Shape 2 (make-posn 1260 300) "yellow")
                          #true))
...
(check-expect (draw_level (make-world 1
              ...
              (place-image (text (number->string 1) 50 "black")
                           level_disp_x level_disp_y
                           (place-image (rectangle (+ (* (* 1 void_region_ramp_up) void_region_width) void_region_width) 600 "solid" "LightSlateGray")
...
(check-expect (draw_void_region (make-world 10
                                            ...
                                            (make-Shape 18 (make-posn 1200 300) "yellow")
                                            #true))
              (place-image (rectangle (+ (* (* 10 void_region_ramp_up) void_region_width) void_region_width) 600 "solid" "LightSlateGray")
