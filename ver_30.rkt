...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ver_30) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Proposal :
...
; future_void_region_calc : world -> Number
...
(define (future_void_region_calc world)
...
; world_level_updater: world level -> world
...
(define (world_level_updater world level)
...
(define (status_check world)
  (cond 
    [ (intersection_checker world) (world_level_updater world (world-level world))] 

    [else                          (world_level_updater world (+ 1 (world-level world)))]))
...
(define (draw_void_region world)
  (cond
    [(void_region_out_of_bounds world) (win_game world)]
    [else (place-image (rectangle (future_void_region_calc world) void_region_height "solid" "LightSlateGray")
                       (- initial_void_region_x (/ 2 (future_void_region_calc world))) initial_void_region_y
