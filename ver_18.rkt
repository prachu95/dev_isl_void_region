...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ver_18) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Proposal :
...
(define (tick world)
  (cond
    [(>= (posn-x world-left_img-pos) (world-width)) (make-world world-level
    ...
    [(<= (posn-x world-right_img-pos) 0)             (make-world world-level
                                                                (make-Shape world-left_img-type  left_obj_starting_posn  world-left_img-colour)
                                                                (make-Shape world-right_img-type right_obj_starting_posn world-left_img-colour)
                                                                world-current_game_status
                                                                world-final_game_status)]
