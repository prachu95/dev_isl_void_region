...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ver_10) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Proposal :
...
; {This will be called by Big-Bang to draw}
...
; {This is called by "draw_object_right"}
